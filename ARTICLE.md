...
would stall every session on the server — and a broken socket raises `IO::Error`,
caught per connection so one dropped client can't cut off the rest of the room.
